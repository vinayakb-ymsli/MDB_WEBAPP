          ...
          <div className="left-section">
            ...
            <div className="dropdown">
              ...
              <div className="dropdown-content">
                <a className="inactive-link" >Analytics</a>
                <a className="inactive-link" >Structure</a>
                <a className="inactive-link" >History</a>
                ...
                <a className="inactive-link" >Search a Repository</a>
              </div>
            </div>
            ...
            <div className="dropdown">
              ...
              <div className="dropdown-content">
                <a className="inactive-link" >Input Images</a>
                <a className="inactive-link" >Output Images</a>
                ...
                <a className="inactive-link" >Inference time graph</a>
                <a className="active-link"
            ...
            <div className="dropdown">
              ...
              <div className="dropdown-content">
                <a className="inactive-link" >Algorithms</a>
                <a className="inactive-link" >Intution</a>
                <a className="inactive-link" >Improvement area</a>
                <a className="inactive-link" >Comparison with older models</a>
                <a className="inactive-link" >Versioning</a>
              </div>
            </div>
            ...
            <div className="dropdown">
              ...
              <div className="dropdown-content">
                ...
                <a className="inactive-link" >Precision recall</a>
                <a className="inactive-link" >F1 score</a>
                <a className="active-link"
                  onClick={() =>
                    openPopup(
                ...
                <a className="inactive-link" >Intersection over union</a>
                {/* <a className="inactive-link" >Area based normality</a> */}
                {/* <a className="inactive-link" >Weights and parameters</a> */}
                <a className="inactive-link" >Precision curve</a>
                {/* <a className="inactive-link" >Pixel based confusion matrix</a>
                <a className="inactive-link" >Pixel based sensitivity curve</a>
                <a className="inactive-link" >Pixel based specificity curve</a> */}
                <a className="inactive-link" >Picking condition</a>
              </div>
            </div>
